...
namespace Route4MeSDK
{
    ...
    public static class PropertyValidation
    {
        ...
        {
            "US","GB","CA","NL","AU","MX","AF","AL","DZ","AS","AD","AO","AI","AQ","AG","AR","AM","AW","AT","AZ","BS","BH","BD","BB",
            "BY","BE","BZ","BJ","BM","BT","BO","BA","BW","BV","BR","BN","BG","BF","BI","KH","CM","CV","KY","TD","CL","CN","CX","CO",
            "KM","CG","CK","CR","HR","CU","CY","CZ","CD","DK","DJ","DM","DO","TP","EC","EG","SV","GQ","ER","EE","ET","FK","FO","FJ",
            "FI","FR","GF","PF","GA","GM","GE","DE","GH","GI","GR","GL","GD","GP","GU","GT","GN","GW","GY","HT","HN","HK","HU","IS",
            "IN","ID","IR","IQ","IE","IL","IT","JM","JP","JO","KZ","KE","KI","KR","KW","KG","LA","LV","LB","LS","LR","LY","LI","LT",
            "LU","MO","MG","MW","MY","MV","ML","MT","MH","MQ","MR","MU","YT","FM","MD","MC","MN","MS","MA","MZ","MM","NA","NR","NP",
            "AN","NC","NZ","NI","NE","NG","NU","NF","KP","NO","OM","PK","PW","PA","PG","PY","PE","PH","PN","PL","PT","PR","QA","RE",
            "RO","RU","RW","KN","LC","WS","SM","SA","SN","SC","SL","SG","SK","SI","SB","SO","ZA","ES","LK","SH","PM","SD","SR","SZ",
            "SE","CH","SY","TW","TJ","TZ","TH","TG","TK","TO","TT","TN","TR","TM","TC","TV","UG","UA","AE","UM","UY","UZ","VU","VA",
            "VE","VN","VG","VI","WF","YE","YU","ZM","ZW"
        };

        private static string[] UsaStateIDs =
        {
            "AK", "AL","AS","AZ","AR","CA","CO","CT","DE","DC","FL","GA","GU","HI","ID","IL","IN","IA","KS","KY","LA","ME","MH","MD","MA",
            "MI","MN","MS","MO","MT","NE","NV","NH","NJ","NM","NY","NC","ND","OH","OK","OR","PW","PA","PR","RI","SC","SD","TN","TX",
            "UT","VT","VI","VA","WA","WV","WI","WY","AE",
            "CA", "AB", "BC", "MB", "NB", "NL", "NT", "NS", "NU", "ON", "PE", "QC", "SK", "YT" // Canadian
        };

        private static string[] AddressStopTypes =
        {
        ...
        public static ValidationResult ValidateLatitude(object value)
        {
            ...
            try
            {
                if (double.TryParse(value.ToString(), out double __))
                {
                    double lat = Convert.ToDouble(value); 
        ...
        public static ValidationResult ValidateLongitude(object value)
        {
            ...
            try
            {
                if (double.TryParse(value.ToString(), out double __))
                {
                    double lng = Convert.ToDouble(value);
        ...
        public static ValidationResult ValidateTimeWindow(object value)
        {
            ...
            try
            {
                if (long.TryParse(value.ToString(), out long __))
                {
                    long tw = Convert.ToInt64(value);
        ...
        public static ValidationResult ValidateCsvTimeWindow(object value)
        {
            ...
            string pattern = @"^[0-1]{0,1}[0-9]{1}\:[0-5]{1}[0-9]{1}$";
        ...
        public static ValidationResult ValidateServiceTime(object value)
        {
            ...
            int servtime = Convert.ToInt32(value);
        ...
        public static ValidationResult ValidatePhone(object value)
        {
            ...
            string pattern = @"^(\+\s{0,1}){0,1}(\(\d{1,3}\)|\d{1,3}){1}[ |-]{1}(\d{2,4}[ |.|-]{1})(\d{2,5}[ |.|-]{0,1}){1}(\d{2,5}[ |.|-]{0,1}){0,1}(\d{2,5}[ |.|-]{0,1}){0,1}$";
        ...
        public static ValidationResult ValidateZipCode(object value)
        {
            ...
            if (value.GetType() != typeof(String))
                return new ValidationResult("The zip code must be a string: " + value.ToString());
        ...
        public static ValidationResult ValidateIsNumber(object value)
        {
            ...
            return double.TryParse(value.ToString(), out double __)
                ? ValidationResult.Success
        ...
        public static ValidationResult ValidateIsBoolean(object value)
        {
            ...
            return bool.TryParse(value.ToString(), out bool __)
                ? ValidationResult.Success
