...
namespace Route4MeDB.ApplicationCore
{
    public class Enum
    {
        ...
        {
            [Description("")] Blank,
            [Description("area-removed")] AreaRemoved,
            [Description("area-added")] AreaAdded,
            [Description("area-updated")] AreaUpdated,
            [Description("delete-destination")] DeleteDestination,
            [Description("insert-destination")] InsertDestination,
            [Description("destination-out-sequence")] DestinationOuSequence,
            [Description("driver-arrived-early")] DriverArrivedEarly,
            [Description("driver-arrived-late")] DriverArrivedLate,
            [Description("driver-arrived-on-time")] DriverArrivedOnTime,
            [Description("geofence-left")] GeofenceLeft,
            [Description("geofence-entered")] GeofenceEntered,
            [Description("mark-destination-departed")] MarkDestinationDeparted,
            [Description("mark-destination-visited")] MarkDestinationVisited,
            [Description("member-created")] MemberCreated,
            [Description("member-deleted")] MemberDeleted,
            [Description("member-modified")] MemberModified,
            [Description("move-destination")] MoveDestination,
            [Description("note-insert")] NoteInsert,
            [Description("route-delete")] RouteDelete,
            [Description("route-optimized")] RouteOptimized,
            [Description("route-owner-changed")] RouteOwnerChanged,
            [Description("route-duplicate")] RouteDuplicate,
            [Description("update-destinations")] UpdateDestinations,
            [Description("user_message")] UserMessage
        }

        public enum UploadType
        {
            [Description("DRIVER_IMG")] DriverImg,
			[Description("VEHICLE_IMG")] VehicleImg,
            [Description("ADDRESS_IMG")] AddressImg,
            [Description("CSV_FILE")] CsvFile,
            [Description("XLS_FILE")] XlsFile,
            [Description("ANY_FILE")] AnyFile
        }
