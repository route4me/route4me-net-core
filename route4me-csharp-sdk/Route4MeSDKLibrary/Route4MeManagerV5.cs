...
namespace Route4MeSDK
{
    ...
    public sealed class Route4MeManagerV5
    {
        ...
        /// </summary>
        [DataContract]
        public sealed class AddressBookContactsRequest : QueryTypes.GenericParameters
        {
        ...
        public string GetAccountPreferedUnit(out ResultResponse failResponse)
        {
            ...
            string prefUnit = user.PreferredUnits;
        ...
        public Vehicle UpdateVehicle(Vehicle vehicleParams, out ResultResponse resultResponse)
        {
            ...
            var content = new StringContent(updateBodyJsonString, System.Text.Encoding.UTF8, "application/json");
        ...
        private Task<Tuple<T, ResultResponse>> GetJsonObjectFromAPIAsync<T>(QueryTypes.GenericParameters optimizationParameters,
                                        string url,
                                        HttpMethodType httpMethod,
                                        bool isString)
        where T : class
