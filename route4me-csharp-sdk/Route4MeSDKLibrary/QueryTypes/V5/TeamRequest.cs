...
namespace Route4MeSDK.QueryTypes.V5
{
    ...
    public sealed class TeamRequest : GenericParameters
    {
        ...
        public bool ShowGlobalAddresses { get; set; } = false;
        ...
        public bool ValidateMemberCreateRequest(out string errorString)
        {
            ...
            {
                if (this.GetMemberType(this.MemberType) == null)
                {
                    errorString = (errorString != null ? Environment.NewLine : "") + "Member type " + this.MemberType + "is not valid";
                    isValid = false;
                }
            }
