...
namespace Route4MeSDK.DataTypes
{
    ...
    ///         <para>
    ///             Every state change invokes a callback webhook event invocation
    ///             if it was provided during the initial optimization.
    ///         </para>
    ///     </remark>
    /// </summary>
    ...
    {
        [Description("tomtom")] Tomtom,

        [Description("teletrac")] Teletrac,

        [Description("azuga")] Azuga,

        [Description("geotab")] Geotab,

        [Description("silentpassenger")] SilentPassenger,

        [Description("new_teletrac")] NewTeletrac
    }
