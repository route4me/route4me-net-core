...
namespace Route4MeSDK.Examples
{
    ...
    {
        /// <summary>
        ///     Insert an address dynamically at the optimal place after last visited.
        /// </summary>
        public void DynamicInsertStopOptimalAfterLastVisited()
        {
            ...
            if (result == null)
            {
                Console.WriteLine("DynamicInsertStopOptimalAfterLastVisited failed.");
                return;
            }
            else
            {
