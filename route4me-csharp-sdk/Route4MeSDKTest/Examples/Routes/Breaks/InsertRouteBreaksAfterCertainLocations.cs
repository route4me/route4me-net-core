...
namespace Route4MeSDK.Examples
{
    ...
    {
        /// <summary>
        /// Insert Route Breaks After Certain Locations.
        /// </summary>
        public void InsertRouteBreaksAfterCertainLocations()
        {
            ...
            var routeBreaks = new RouteBreaks()
            {
                ...
                Breaks = new RouteBreak[]
                {
                    new RouteBreak()
                    {
                        Type = RouteBreakTypes.CERTAIN_NUMBER_OF_LOCATIONS.Description(),
                        Duration = 900,
                        Params = new int[] { 7, 7 }
                    }
                },
            ...
            if (result == null)
            {
                Console.WriteLine("InsertRouteBreaksAfterCertainLocations failed.");
                return;
            }
