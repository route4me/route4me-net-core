...
namespace Route4MeSDK.Examples
{
    ...
    {
        /// <summary>
        /// The example refers to the process of getting an orders history 
        /// asynchronously using the API 5 endpoint.
        /// </summary>
        public async void GetOrdersHistoryV5Async()
        {
            ...
            var result = await route4Me.GetOrderHistoryAsync(parameters);
