...
namespace Route4MeSDK.Examples
{
    public sealed partial class Route4MeExamples
    {
        ...
        public void GetDeviceHistoryTimeRange(string routeId)
        {
            ...
            int uStartTime = (int)(new DateTime(2016, 10, 20, 0, 0, 0) - (new DateTime(1970, 1, 1, 0, 0, 0))).TotalSeconds;
            int uEndTime = (int)(new DateTime(2016, 10, 26, 23, 59, 59) - (new DateTime(1970, 1, 1, 0, 0, 0))).TotalSeconds;
